...
import { useSavedIndicator } from "~entries/options/hooks/use-saved-indicator"
import {
  createEmptyLayout,
  createProvider,
  createRule,
  ...
  createTheme,
  layoutRegions
} from "~entries/options/model"
import { SectionHeading } from "~entries/options/sections/section-heading"
import {
  CheckField,
  ColorField,
  NumberField,
...
function OptionsPage() {
  ...
  const { saved, showSaved } = useSavedIndicator()
  ...
  return (
    <main className="options-shell font-utility text-ink">
      ...
      <section className="workspace-section">
        <SectionHeading eyebrow="THEMES" title="主题库">
      ...
      <section className="workspace-section shortcuts-section">
        <SectionHeading eyebrow="POPUP SHORTCUTS" title="快捷主题">
