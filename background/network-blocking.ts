...
export function registerNetworkBlocking() {
  void syncNetworkBlocking()
  chrome.runtime.onInstalled.addListener(() => void syncNetworkBlocking())
  chrome.runtime.onStartup.addListener(() => void syncNetworkBlocking())
